<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="user") {echo "active";}?>"><a href="user/dashboard.php"><em class="fa fa-user-circle">&nbsp;</em>User Dashboard</a></li>
			<li class="<?php if($page=="user_details") {echo "active";}?>"><a href="user_details.php"><em class="fa fa-info-circle">&nbsp;</em>User Details</a></li>
		</ul>
